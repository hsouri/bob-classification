...
@register_model
def resnet50x2_vicreg(pretrained=True, **kwargs):
    model, _ = resnet50x2(**kwargs)
    if pretrained:
        state_dict = torch.hub.load_state_dict_from_url(
...
@register_model
def resnet200x2_vicreg(pretrained=True, **kwargs):
    model, _ = resnet200x2(**kwargs)
    if pretrained:
        state_dict = torch.hub.load_state_dict_from_url(
