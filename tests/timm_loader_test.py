...
python timm_loader_test.py -b 128 --model resnet18 --sched cosine --epochs 300 --lr 1e-3 --weight-decay 0.05 --aa rand-m9-mstd0.5-inc1 --reprob 0.25 --mixup 0.8 --cutmix 1.0 --drop-path 0.1 --opt adamw --amp --distillation-type none --dataset iwildcam --train-split train --val-split test /fs/cml-datasets/WILDS/
"""
import argparse
import logging
import time
...
from timm_dataset import create_other_dataset 
...
# finetune parameters
group.add_argument('--linear_prob', action='store_true', default=False,
                    help='use NVIDIA Apex AMP or Native AMP for mixed precision training')
