from datasets.wilds.wilds import get_dataset
from datasets.wilds.wilds.common.data_loaders import get_train_loader
import torchvision.transforms as transforms

from datasets.wilds.wilds.common.grouper import CombinatorialGrouper
...
train_loader = get_train_loader("group", train_data, grouper=grouper, n_groups_per_batch=1, batch_size=16, specific_group=0)
