...
from datasets.transfer_cls_datasets import SemiImageNet
...
def main():
    ...
    print(args.num_classes, num_classes[args.dataset.lower()])
    ...
    if args.dataset.lower() == "semiimagenet":
        dataset_train = SemiImageNet(args.data_dir, 'train', args.n_shot)
        dataset_eval = torchvision.datasets.ImageFolder(os.path.join(args.data_dir, 'val'))
    elif args.dataset != "" and args.dataset.lower() != "imagenet":
